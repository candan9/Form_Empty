...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->show›ntenseToolStripMenuItem->Size = System::Drawing::Size(180, 22);
...
#pragma endregion
	...
	public: void erosion() {
	    ...
	    int  cK = 0;
		//indis counterlar˝ ve check counterlar˝
		for (int row = 0; row < Height; row++)
		{
			for (int col = 0; col < Width; col++)
			{
				if (col == Height-1 || col == 0|| row==0 || row ==Width-1) {//resmin d˝˛ k˝sm˝n˝ 0 yapma
